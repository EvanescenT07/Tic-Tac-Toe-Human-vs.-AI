...
def train_ai_model():
    ...
    ai_player_1.q.save('model.h5')
    print('Model saved as model.h5')

def play_game_with_saved_model():
    loaded_model = load_model('model.h5')
    ai_player_1 = AIPlayer()
    ai_player_1.q = loaded_model
...
if __name__ == '__main__':
    train_or_play = input('Enter "train" to train the model or "play" to play the game: ')
    ...
    if train_or_play == 'train':
        ...
        print('Invalid choice. Enter "train" or "play"')
